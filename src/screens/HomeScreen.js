        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.templatesRow}>
          {templates.map((item) => (
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate("Editor", { templateName: item })}
            >
              <View style={styles.templateAccent} />
              <Text style={styles.templateTitle}>{item}</Text>
              <Text style={styles.templateText}>Abrir base visual y empezar a editar</Text>
            </TouchableOpacity>
          ))}
        </ScrollView>
      </View>
