...
export default function EditorScreen({ navigation, route }) {
  ...
  const currentTransition = useMemo(() => {
    ...
    return transitionsByGap[currentIndex - 1] || "";
  }, [currentIndex, transitionsByGap]);
  ...
  const downloadProject = async () => {
    ...
    Alert.alert("Descargar", "De momento descarga el proyecto. La exportación final viene después.");
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.editorLayout}>
        <View style={styles.previewArea}>
          <View style={styles.previewInnerWrap}>
        ...
        <View style={styles.dockArea}>
          ...
          <View style={styles.timelinePanel}>
                      ...
                      {index < clips.length - 1 && (
                        <TouchableOpacity
                          style={[
                            ...
                            hasTransition ? styles.transitionBlockActive : styles.transitionBlockIdle,
                          ]}
                          onPress={() => openGapEditor(index)}
                        >
                          <Text style={styles.transitionBlockText}>
                            {hasTransition ? "FX" : "+"}
                          </Text>
                        </TouchableOpacity>
                      )}
            ...
            <View style={styles.audioTrackBlock}>
              <View style={[styles.audioTrackFill, audioTrack && styles.audioTrackFillLoaded]} />
            </View>
          </View>
        </View>
      </View>
